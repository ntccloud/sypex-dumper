...
'ver'				=> 210, // Для какой версии предназначен файл
...
//[FIX 21.03.2017 2.1]
'auth'				=> 'Введите данные для доступа к БД',
'lang' => 'Язык:',
...
'set_delim' => 'Установлен разделитель таблицы`%s`',
'off_indexes' => 'Отключаем индексы таблицы`%s`',
'restore_begin'		=> 'Выбрана БД `%s`',
